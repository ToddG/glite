...
@external(erlang, "glite_child_ffi", "start_child")
pub fn start(
  sup_pid: Pid,
...
@external(erlang, "glite_child_ffi", "delete_child")
pub fn delete(sup_pid: Pid, id: Int) -> Result(Nil, DeleteError)

@external(erlang, "glite_child_ffi", "restart_child")
pub fn restart(sup_pid: Pid, id: Int) -> Result(Pid, DeleteError)

@external(erlang, "glite_child_ffi", "terminate_child")
pub fn terminate(sup_pid: Pid, id: Int) -> Result(Nil, NotFound)
