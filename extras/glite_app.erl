...
%%% @copyright (C) 2025, Mikael Karlsson
%%% @doc
%%%
%%% @end
%%% Created : 30 May 2025 by Mikael Karlsson <mikael.karlsson@creado.se>
%%%-------------------------------------------------------------------
-module(glite_app).
...
%% @private
%% @doc
%% top supervisor of the tree. (Optional)
...
%% before shutting down the processes of the application. (Optional)
%% @end
%%--------------------------------------------------------------------
...
%% if the configuration parameters have changed. (Optional)
%% @end
%%--------------------------------------------------------------------
